        ...
        >
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center items-center h-full p-12 text-gray-900 dark:text-white mx-auto">
                    ...
                    >
                        Dive back into your journey with us and continue crafting engaging stories.
                    </motion.p>
                ...
                <div className="w-full max-w-md">
                    ...
                    >
                        <p className="text-gray-600 dark:text-gray-400">
                            ...
                            <Link to="/register" className="font-medium text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300 transition-colors duration-200">
                                Sign up
                            </Link>
                        </p>
                    </motion.div>
